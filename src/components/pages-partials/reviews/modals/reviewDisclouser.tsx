          ...
          <Box>
            <Typography sx={{ fontSize: '0.9rem' }}>
              ...
              <span style={{ color: colorText === 'noConflicts' ? COLORS.BLUE_600 : 'black' }}>
                Since there wasn&apos;t compensation given, there are no conflicts of interest
                present that would affect the review.{' '}
              </span>
              This review was provided for informational purposes only and is not representative of
              all client experiences. There is no assurance that a current or prospective client
              will experience a high level of satisfaction with Top Advisor services.
            </Typography>
            <Typography
              sx={{
                fontSize: '0.9rem',
