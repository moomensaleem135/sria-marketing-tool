  ...
  return (
    <Box>
      ...
      <Box>
        ...
        <Box>
          <Typography sx={{ fontSize: '0.9rem' }}>
            The client above was indirectly compensated with reduced fees that totaled $950 dollars.{' '}
            ...
            experiences. There is no assurance that a current or prospective client will experience
            a high level of satisfaction with Top Advisor services.
          </Typography>
          <Typography
            sx={{
              fontSize: '0.9rem',
