...
const DisclouserConflicts = () => {
  const [isDisclouserModal, setIsDisclouserModal] = useState<boolean>(false);

  return (
    <Box>
      {/* <Typography sx={{ fontSize: '0.8rem' }}>
        If compensation is exchanged for a testimonial or endorsement, then a material conflict of
        interest exists. It’s required to state this conflict in the disclosure.
        <span
        ...
        <Box>
          <Typography sx={{ fontSize: '0.9rem' }}>
            ...
            <span style={{ color: COLORS.BLUE_600 }}>
              ...
              would affect the testimonial.
            </span>{' '}
            Top Advisors reached out to all clients requesting voluntary feedback and these were the
          ...
          <Typography sx={{ fontSize: '0.9rem', marginTop: '1rem', color: COLORS.BLUE_600 }}>
...
export default DisclouserConflicts;
