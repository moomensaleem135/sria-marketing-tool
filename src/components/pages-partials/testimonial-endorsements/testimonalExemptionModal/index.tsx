...
const TestimonialEndorsementModal = () => {
  const [isTestEndModal, setIsTestEndModal] = useState<boolean>(false);

  return (
    <Box>
      <Typography sx={{ fontSize: '0.9rem', fontWeight: 'bold' }}>
        Is a disclosure displayed clearly and prominently by the testimonial/endorsement?{' '}
        <span
...
export default TestimonialEndorsementModal;
